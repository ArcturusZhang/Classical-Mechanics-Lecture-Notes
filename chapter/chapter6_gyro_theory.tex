...
下面考虑Euler情形下，刚体在空间系中的绝对运动，即相对于固定坐标系$OXYZ$的运动。令$Z$轴沿着矢量$\mbf{L}$的方向，由于方向$Z$相对$x_1,x_2,x_3$轴的极角和方位角分别为$\theta$和$\dfrac{\pi}{2}-\psi$\label{chapter6:footnote-Euler角和球坐标系之间的关系}。此处“极角”和“方位角”即为球坐标系
\[
\begin{cases}
