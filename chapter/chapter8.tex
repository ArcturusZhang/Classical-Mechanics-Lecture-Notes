...
% \begin{example}[刚体撞墙]
% 设刚体$B_2$为固定障碍物，令$\mbf{v}_2^-=\mbf{0},\mbf{\omega}_2^-=\mbf{0}$并且$m_2, I_{x_2}, I_{y_2}, I_{z_2}$都为无穷大，求刚体$B_1$碰撞后的运动状态。
% \end{example}
% \begin{solution}
% 简便起见，略去刚体$B_1$的下标$1$，则有
% \begin{equation*}
	% \mu^2 = \frac1m + \frac{(y\gamma-z\beta)^2}{I_x} + \frac{(z\alpha-x\gamma)^2}{I_y} + \frac{(x\beta-y\alpha)^2}{I_z}
% \end{equation*}
% \end{solution}
