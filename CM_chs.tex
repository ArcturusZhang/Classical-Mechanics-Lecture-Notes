...
\input{chapter/chapter4}%第四章——两体问题

\input{chapter/chapter5}%第五章——多自由度微振动与阻尼

\input{chapter/chapter6}%第六章——刚体

\input{chapter/chapter8}%第八章——撞击运动理论

\input{chapter/chapter7}%第七章——非惯性系

\input{chapter/chapter3}%第三章——哈密顿力学
